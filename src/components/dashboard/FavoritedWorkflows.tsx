...
export function FavoritedWorkflows() {
    ...
    if (viewMode === 'workflows') {
      if (favoritedWorkflows && favoritedWorkflows.length > 0) {
        return <div className="space-y-2">
            {favoritedWorkflows.map(workflow => <div key={workflow.id} className="flex items-center justify-between py-2 px-4 rounded-lg border border-border/50 hover:bg-accent/20 transition-colors">
        ...
        return <div className="text-center py-6 text-muted-foreground">
            ...
            <Button variant="outline" className="mt-3" onClick={handleCreateWorkflow}>
  ...
  return <div className="rounded-xl border bg-card shadow-sm">
      <div className="flex items-center justify-between p-4 border-b">
        ...
        <Button variant="outline" size="sm" className="gap-2" onClick={handleCreateWorkflow}>
