...
export function AgentActions({
  ...
  return <div className="flex items-center justify-end gap-2">
      {onToggleFavorite && <Button variant="ghost" size="icon" onClick={handleToggleFavorite} className="text-yellow-500">
      ...
      <Button variant="ghost" size="icon" onClick={() => onEditAgent(agent)}>
        <Edit className="h-4 w-4" />
      </Button>
      <Button variant="ghost" size="icon" onClick={() => onDeleteAgent(agent.id)}>
