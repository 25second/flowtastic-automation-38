            ...
            <div className="h-full w-full relative isolate">
              <div className="absolute top-4 right-4 flex items-center gap-4 z-[100]">
                <Button
                  ...
                  className="flex items-center gap-2 bg-gradient-to-br from-[#9b87f5] to-[#8B5CF6] hover:from-[#8B5CF6] hover:to-[#7C3AED] text-white shadow-lg hover:shadow-purple-500/50 transition-all duration-300 hover:scale-105 animate-fade-in group pointer-events-auto relative"
                >
                ...
                <Button
                  ...
                  className="flex items-center gap-2 bg-gradient-to-br from-[#F97316] to-[#FEC6A1] hover:from-[#EA580C] hover:to-[#FB923C] text-white shadow-lg hover:shadow-orange-500/50 transition-all duration-300 hover:scale-105 animate-fade-in group pointer-events-auto relative"
                >
                ...
                <div className="flex items-center gap-3 animate-fade-in pointer-events-auto relative">
                  <Button
                    variant="secondary"
                    size="icon"
                    onClick={handleSave}
